...
class ML_models():
    def __init__(self,data_icu,k_fold,model_type,concat,oversampling):
        ...
        self.fold=0
        self.loss=evaluation3.Loss('cpu',True,True,True,True,True,True,True,True,True,True,True)
        self.ml_train()
    ...
    def train_model(self,X_train,Y_train,X_test,Y_test):
        #logits=[]
        print("===============MODEL TRAINING Gradient Bossting===============")
